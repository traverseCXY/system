...
<head>
	...
	$(function() {
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"/exam/teacherExamList",//"ExamServlet?method=TeacherExamList&t="+new Date().getTime(),
	        idField:'id', 
	    ...
	    $("#add").click(function(){
	    	$.ajax({
				type: "post",
				url: "/teacher/getTeacher",//"TeacherServlet?method=GetTeacher&t="+new Date().getTime(),
				dataType: "json",
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "/exam/addExam",//"ExamServlet?method=AddExam&t="+new Date().getTime(),
								data: data,
								success: function(msg){
									if(msg == "success"){

										$.messager.alert("消息提醒","添加成功!请老师尽快添加对应题库","info");
										//关闭窗口
