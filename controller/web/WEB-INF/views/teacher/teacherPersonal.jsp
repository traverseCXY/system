	    	...
	    	buttons: [
	  	    		{
	  					...
	  					handler:function(){
	  						...
	  						if(!validate){
	  							...
	  							$.ajax({
	  								type: "post",
	  								url: "/teacher/editPasswod",//"StudentServlet?method=EditPasswod&t="+new Date().getTime(),
	    	...
	    	toolbar: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "/teacher/editTeacherPersonal",//"TeacherServlet?method=EditTeacherPersonal&t="+new Date().getTime(),
...
<body>
	...
	<div id="editDialog" style="padding: 20px">
		<div style="width: 300px; height: 400px;float: right; margin: 20px 120px 0 0;">
	    	<img id="user_photo" alt="照片" style="margin-bottom: 30px;display: block;max-width: 250px; max-height: 300px;" title="照片" src="${userDetail.photo}" />
	    	<form id="uploadForm" method="post" enctype="multipart/form-data" action="/teacher/editTeacherPhoto" target="photo_target">
