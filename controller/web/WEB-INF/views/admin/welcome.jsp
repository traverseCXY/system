...
<body>
<div title="欢迎使用" style="padding:20px;overflow:hidden; color: #48484c; " >
	...
	<p>服务器：tomcat 8.0</p>
	<p>数据库：Sqlserver</p>
	<p>系统采用技术： Servlet+Jsp+Jdbc+dbutils+EasyUI+Bootstrap+jQuery+Ajax+spring mvc+spring+mybaties+junit+面向接口编程</p>
</div>
</body>
</html>