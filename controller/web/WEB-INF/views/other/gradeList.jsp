...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"/grade/list?course=course",//"GradeServlet?method=GradeList&course=course&t="+new Date().getTime(),
	        idField:'id', 
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除与年级相关的所有数据(包括班级,学生)，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url:"/grade/deleteByGradeId",// "GradeServlet?method=DeleteGrade",
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "/grade/addGrade",//"GradeServlet?method=AddGrade",
