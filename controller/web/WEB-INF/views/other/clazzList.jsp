...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"/clazz/list",//"ClazzServlet?method=ClazzDetailList&t="+new Date().getTime(),
	        idField:'id', 
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除与班级相关的所有数据(包括学生)，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "/clazz/deleteClazz",//"ClazzServlet?method=DeleteClazz",
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "/clazz/addClazz",//"ClazzServlet?method=AddClazz",
