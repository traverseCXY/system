...
public class Teacher {
	...
	public Teacher(String number, String name, String sex, String phone, String qq) {
		this.number = number;
		this.name = name;
		this.sex = sex;
		this.phone = phone;
	...
	public Teacher(int id, String number, String name, String sex, String phone, String qq, String photo) {
		this.id = id;
		this.number = number;
		this.name = name;
		this.sex = sex;
